...
PINS = [
    ...
    (7, "+10V", "PWR", 0.2, -6.18),
    (8, "USB_D+", "SIG", -10.45, -4.87),
    (9, "GND", "PWR", -5.8, -4.18),
    (10, "GND", "PWR", -3.8, -4.18),
    (11, "USB_D-", "SIG", -10.45, -2.87),
    (12, "+5V", "PWR", -8.45, -2.88),
    (13, "GND", "PWR", 8.45, 0.01),
    (14, "GND", "PWR", 10.45, 0.01),
    (15, "MOTOR2", "SIG", -5.82, 1.9),
    (16, "MOTOR4", "SIG", -3.82, 1.9),
    (17, "GND", "PWR", -1.82, 1.9),
    (18, "GND", "PWR", 0.18, 1.9),
    (19, "BUZZER-", "SIG", 10.45, 2.01),
    (20, "MOTOR1", "SIG", -5.82, 3.9),
    (21, "MOTOR3", "SIG", -3.82, 3.9),
    (22, "GND", "PWR", -1.82, 3.9),
    (23, "GND", "PWR", 0.18, 3.9),
    (24, "+BATT", "PWR", -8.3, 4.01),
    (25, "GND", "PWR", -7.13, 6.86),
    (26, "GND", "PWR", -4.12, 6.86),
    (27, "GND", "PWR", 2.97, 8.56),
    (28, "UART0_TX", "SIG", 4.97, 8.56),
    (29, "UART0_RX", "SIG", 6.97, 8.56),
    (30, "LED_STRIP", "SIG", -7.13, 8.86),
    (31, "UART1_RX", "SIG", -3.13, 8.86),
    (32, "UART1_TX", "SIG", -1.13, 8.86),
]
# PINS-END
