...
PINS = [
    ...
    (7, "USB_D+", "SIG", -10.45, -4.87),
    (8, "GND", "PWR", -5.8, -4.18),
    (9, "GND", "PWR", -3.8, -4.18),
    (10, "USB_D-", "SIG", -10.45, -2.87),
    (11, "+5V", "PWR", -8.45, -2.88),
    (12, "GND", "PWR", 8.45, 0.01),
    (13, "GND", "PWR", 10.45, 0.01),
    (14, "MOTOR2", "SIG", -5.82, 1.9),
    (15, "MOTOR4", "SIG", -3.82, 1.9),
    (16, "GND", "PWR", -1.82, 1.9),
    (17, "GND", "PWR", 0.18, 1.9),
    (18, "BUZZER-", "SIG", 10.45, 2.01),
    (19, "MOTOR1", "SIG", -5.82, 3.9),
    (20, "MOTOR3", "SIG", -3.82, 3.9),
    (21, "GND", "PWR", -1.82, 3.9),
    (22, "GND", "PWR", 0.18, 3.9),
    (23, "+BATT", "PWR", -8.3, 4.01),
    (24, "GND", "PWR", -7.13, 6.86),
    (25, "GND", "PWR", -4.12, 6.86),
    (26, "GND", "PWR", 2.97, 8.56),
    (27, "UART0_TX", "SIG", 4.97, 8.56),
    (28, "UART0_RX", "SIG", 6.97, 8.56),
    (29, "LED_STRIP", "SIG", -7.13, 8.86),
    (30, "UART1_RX", "SIG", -3.13, 8.86),
    (31, "UART1_TX", "SIG", -1.13, 8.86),
]
# PINS-END
