...
- Run ERC and DRC before opening a PR and do not add new violations; the design is mid-refresh (see [hardware/docs/DESIGN.md](hardware/docs/DESIGN.md)), so existing violations are known:
